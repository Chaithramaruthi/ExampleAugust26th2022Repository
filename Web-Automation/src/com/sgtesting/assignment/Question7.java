...
//launchBrowser --> navigate --> Login --> Create Customer --> Create Project-->Modify Project--> delete Project-->
...
public class Question7 {
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("Infotech");
